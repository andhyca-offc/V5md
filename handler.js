                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let wel = API('hardianto', '/api/welcome3', {
                                ...
                                bg: 'https://telegra.ph/file/935b88bd02274c6bfdb7c.jpg',
...
sourceUrl: sgc
    ...
    let msgg = {
    	unreg: '💌 ᴀᴋꜱᴇꜱ ᴅɪ ᴛᴏʟᴀᴋ, ᴀɴᴅᴀ ᴘᴇʀʟᴜ ᴠᴇʀɪꜰɪᴋᴀꜱɪ ꜱᴇʙᴇʟᴜᴍ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴀɴᴅʜʏᴄᴀ ʙᴏᴛ ♨️\n\n📮➞ ᴋʟɪᴄᴋ ᴠᴇʀɪꜰɪᴋᴀꜱɪ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ ☟︎︎︎'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} *VERIFYCATION* ${global.htka}`, msgg, null, ['꧁▣ ᴠᴇʀɪғʏ ▣꧂', '/verify'],m)
}
