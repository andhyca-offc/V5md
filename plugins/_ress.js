...
export async function all(m) {
  ...
  let pp = await this.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/935b88bd02274c6bfdb7c.jpg')
...
mediaType:  1,
mediaUrl: 'https://wa.me/6285872761910',
title: '「 ❔ 」',
body: wm,
sourceUrl: 'https://instagram.com/andhycarsroffixial', thumbnail: await( await fetch(pp)).buffer()
