...
case 'ecchi':
         if (ecchi == true) { 
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['🌟 ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['🌹 ᴏᴡɴᴇʀ', '.owner nomorz']], m)
		 }
